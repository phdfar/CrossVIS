        ...
        if self.training:
            ...
            if len(pred_instances) == 0:
                ...
                if self.boxinst_enabled:
                    ...
                    #print('mask_losses',mask_scores.size())
                    #print('gt_bitmasks',gt_bitmasks.size())
                    #print('mask_losses',mask_losses.size())

                    loss_mask_lovas = lovasz_hinge_loss(mask_scores.flatten(), gt_bitmasks.flatten())
                    #print('loss_mask_lovas',loss_mask_lovas)


                    #print(ads)

                    losses['loss_mask'] = loss_mask + loss_mask_lovas
