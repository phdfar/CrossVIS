...
class _DefROIAlign(Function):
    @staticmethod
    def forward(ctx, input, roi, offsets, output_size, spatial_scale,
        ...
        ctx.aligned = aligned
        output = _C.def_roi_align_forward(input, roi, offsets, spatial_scale,
...
class DefROIAlign(nn.Module):
    ...
    def forward(self, input, rois, offsets):
        ...
        return def_roi_align(input, rois, offsets, self.output_size,
