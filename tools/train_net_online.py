...
from adet.data.build import build_youtubevis_train_loader
...
class Trainer(DefaultTrainer):
        ...
        with EventStorage(start_iter) as self.storage:
            ...
            for self.iter in range(start_iter, max_iter):
                ...
                if self.iter>0 and self.iter%1000==0:
                    ...
                    os.system('python /kaggle/working/CrossVIS/test_vis.py --config-file /kaggle/working/CrossVIS/configs/CrossVIS/R_50_1x.yaml --json-file /kaggle/working/CrossVIS/datasets/youtubevis/annotations/valid.json --opts MODEL.WEIGHTS /kaggle/working/CrossVIS/output/CrossVIS_R_50_1x/model_0000999.pth')
            self.after_train()
    ...
    def build_train_loader(cls, cfg):
        ...
        elif cfg.MODEL.CROSSVIS_ON:
            mapper = VideoDatasetMapperWithBasis(cfg, True)
            return build_youtubevis_train_loader(cfg, mapper=mapper)
        else:
